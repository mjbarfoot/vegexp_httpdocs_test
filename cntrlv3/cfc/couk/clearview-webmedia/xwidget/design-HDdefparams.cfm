...
request.xwtable.setValue(arguments.tblname,"colwidths", "26px,75px,69px, ,65px,120px,61px,42px,92px"); 
...
request.xwtable.setValue(arguments.tblname,"columnnamelist","Show More,WONUM,SUPPLIER,DESCRIPTION,DATE REQUESTED,DATE FIN COMPLETED,AMCLM`D TOTAL,WORK TYPE,AUDIT STATUS");
request.xwtable.setValue(arguments.tblname,"columnSortable", "false,false,false,false,DATE_REQUESTED,DATE_FINCOMP,false,false,QSA_STATUS");
request.xwtable.setValue(arguments.tblname,"columnShowHideTitleList", "0,1,1,1,1,1,1,1,1");
request.xwtable.setValue(arguments.tblname,"columntypelist","custom,query,query,query,custom,custom,query,query,custom");
request.xwtable.setValue(arguments.tblname,"columnformatlist","text,text,text,text,text,text,text,text,text");
...
request.xwtable.setValue(arguments.tblname,"customcolumnvaluelist", "getHistoryArrow(WONUM), qsdateformat(DATE_REQUESTED), qsdateformat(DATE_FINCOMP), qsstatus(QSA_STATUS)");
request.xwtable.setValue(arguments.tblname,"customcolumntypelist",  "function, function, function, function");
