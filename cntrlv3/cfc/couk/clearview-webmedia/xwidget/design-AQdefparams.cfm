...
request.xwtable.setQuery(arguments.tblname, "sqlquery", SESSION.qry.auditqueue);
...
request.xwtable.setValue(arguments.tblname, "query.table", "SESSION.qry.auditqueue");
...
request.xwtable.setValue(arguments.tblname,"columnnamelist","Show More,SELECT,WONUM,SUPPLIER,DESCRIPTION,DATE REQUESTED,DATE FIN COMPLETED,AMCLM`D TOTAL,WORK TYPE,AUDIT STATUS");
request.xwtable.setValue(arguments.tblname,"columnSortable", "false,false,false,false,false,DATE_REQUESTED,DATE_FINCOMP,false,false,QSA_STATUS");
...
request.xwtable.setValue(arguments.tblname,"customcolumnvaluelist", "getArrow(WONUM), getSelectBox(WONUM), qsdateformat(DATE_REQUESTED), qsdateformat(DATE_FINCOMP), qsstatus(QSA_STATUS)");
