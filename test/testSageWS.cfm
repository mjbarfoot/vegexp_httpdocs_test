...
<cfset var tickEnd=0>
	...
	<cfhttp url="http://localhost:81/accountsWS/AccountsIntegration.asmx/AccountsStatus"
			method="post">
...
<soap:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
  <soap:Body>
	...
	<cfhttp url="http://localhost:81/accountsWS/AccountsIntegration.asmx" GetAsBinary="no" charset="utf-8" method="post">
  ...
  <soap:Body>
    <PlaceSalesOrder xmlns="http://www.aspidistra.com/WebService/AccountsIntegration/">
      <order>     	
        ...
        <CustomerAddress3>ack</CustomerAddress3>
...
<cfoutput>
Returned Order number: #MyXmlDoc.xmlRoot.xmlChildren[2].PlaceSalesOrderResponse.PlaceSalesOrderResult.xmlText# <br /> 
Response time: #tickinterval# seconds <br />
<!--- <p>Response#htmleditformat(trim(cfhttp.filecontent))#</p> --->
<ul>
<li>cfhttp.charSet: #cfhttp.charSet#</li>
<li>cfhttp.errorDetail: #cfhttp.errorDetail#</li>
...
<cffunction name="GetSalesOrderHistory" output="true" returntype="void" access="private">
...
<soap:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
  <soap:Body>
    <GetSalesOrderHistory xmlns="http://www.aspidistra.com/WebService/AccountsIntegration/">
      <accountCode>WEBTEST</accountCode>
...
<cfhttp url="http://localhost:81/accountsWS/AccountsIntegration.asmx" method="post">
	<cfhttpparam type="header" name="SOAPAction" value="http://www.aspidistra.com/WebService/AccountsIntegration/GetSalesOrderHistory">
	<cfhttpparam name="xml" value="#toString(soap)#" type="xml" />
</cfhttp>
...
<cfoutput>#GetSalesOrderHistory()#<!--- #registerUser()# ---></cfoutput>
