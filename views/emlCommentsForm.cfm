...
Msg.body = structnew();
Msg.body.commentAbout="/index.cfm";
Msg.body.commentTitle="This is a comment about your website";
Msg.body.yourName="Johny  Teser";
Msg.body.emailAddress="johny@testing.com";
Msg.body.comment="This is a test comment";
}	
...
<head>
<title>Vegetarian Express Website Comment</title>
<style>
...
<div id="wrapper">
	...
	A customer/visitor to the website gave the following comments on #Dateformat(now(), "dd/mm/yyyy")# at #timeformat(now(), "H:MM TT")#:
	<ul>
	<li>Comment Title: #Msg.body.commentTitle#</li>
	<li>Commenting on: #Msg.body.commentAbout#</li>
	<li>Name: #Msg.body.yourname#</li>
