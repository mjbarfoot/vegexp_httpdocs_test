...
Msg.title = "Sales Order Delay Confirmation - Order No: " & Msg.OrderID;
...
<div id="wrapper">
	...
	<div id="checkoutContainer">
		...
		<p>
			...
			Thanks for placing order #Msg.OrderID# with Vegetarian Express.

		</p>

        <p>
            There will be a small delay whilst we add the order below to our order fulfilment system.
            <br/>
            <br/>
            A member of the sales team will confirm by phone or email once you order has been added.
        </p>
