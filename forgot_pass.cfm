<cfset shopperBreadcrumbTrail=session.shopper.breadcrumb.getBreadCrumbTrail("Reset your password") />
<cfscript>
			...
			<div id="body" class="clearfix">		
					...
					<div id="productListWrapper">
						<div id="productList">
							...
							<p style="margin-bottom:1em;">Enter your details below and we will send you an email enabling you to reset your password.</p>
							<span class="fieldsetTitle">Please enter your Account Code and Email Address</span>
								<fieldset>
								<p>
								...
								<input type="hidden" name="submittype" id="submittype" value="reset" />
