...
if (VARIABLES.isSuccessful) {
	...
	favlog.write("#timeformat(now(), 'H:MM:SS')# Error - Query: uFavourites failed trying to update LastOrderQuantity, erroring row was #error_row#, tried to  values #error_values#, error details: #error_text#");
}
</cfscript>
