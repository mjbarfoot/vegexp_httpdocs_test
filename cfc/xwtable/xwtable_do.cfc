...
var query_columns		 =APPLICATION.xwtable.getValue(arguments.tblname, "querycolumnprimarykey") & "," & APPLICATION.xwtable.getValue(arguments.tblname, "querycolumnlist");
var query_dsn 	 		 =APPLICATION.xwtable.getValue(arguments.tblname, "query.dsn");
var query_table	 		 =APPLICATION.xwtable.getValue(arguments.tblname, "query.table");
var wherestatement 		 =APPLICATION.xwtable.getValue(arguments.tblname, "wherestatement");  
var wherecol			 =APPLICATION.xwtable.getValue(arguments.tblname, "wherecol");  
var whereclause 		 =APPLICATION.xwtable.getValue(arguments.tblname, "whereclause");  
var sortcol				 =APPLICATION.xwtable.getValue(arguments.tblname, "sortcol");  
var sortorder			 =APPLICATION.xwtable.getValue(arguments.tblname, "sortorder");  
...
<!--- Query of Queries --->
<cffunction name="doQoQ" access="public" hint="performs a sql query against the specified dsn">
<cfargument name="tblname" required="true" type="string" />
<cfscript>
//grab the query columns 
var query_columns		 = APPLICATION.xwtable.getValue(arguments.tblname, "querycolumnlist");
var SQLquery	 		 =APPLICATION.xwtable.getValue(arguments.tblname, "sqlquery");
var wherestatement 		 =APPLICATION.xwtable.getValue(arguments.tblname, "wherestatement");  
var wherecol			 =APPLICATION.xwtable.getValue(arguments.tblname, "wherecol");  
var whereclause 		 =APPLICATION.xwtable.getValue(arguments.tblname, "whereclause");  
var sortcol				 =APPLICATION.xwtable.getValue(arguments.tblname, "sortcol");  
