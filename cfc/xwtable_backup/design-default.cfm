...
request.xwtable.setValue(arguments.tblname,"customcolumnvaluelist", "convertCodesToIcons(Description;StockID), getPortionSize(UnitofSale;SalePrice), getDiscountedPrice(SalePrice), prodInfoLinks(StockID),<a class='addtobasket' href='#cgi.script_name#?#xmlformat(cgi.QUERY_STRING)#&amp;ev=basket&amp;action=Add&amp;ProductID=:stockid'>Add</a>");
request.xwtable.setValue(arguments.tblname,"customcolumntypelist",  "function, function, function, function, URI");
