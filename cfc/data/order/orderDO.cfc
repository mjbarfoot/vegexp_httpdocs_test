...
<cfargument name="order" required="true" type="cfc.model.order.order" />

<cfset mybasket = ARGUMENTS.order.getBasket() />


	<!--- save order info --->
	<cfquery name="qryAddOrder" datasource="#APPLICATION.dsn#">
	INSERT INTO tblOrder
	(WebOrderID,AccountID,OrderTS,OrderDate,OrderTime,OrderStatus,OrderStatusDesc,OrderStatusError,Amount,
	...
	<cfqueryparam cfsqltype="cf_sql_varchar" value="#ARGUMENTS.order.getOrderID()#">,
	<cfqueryparam cfsqltype="cf_sql_varchar" value="#ARGUMENTS.order.getAccountID()#">,
	<cfqueryparam cfsqltype="cf_sql_varchar" value="#getTickCount()#">,
	<!--- MSACCESS:	
